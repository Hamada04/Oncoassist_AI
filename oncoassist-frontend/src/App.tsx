...
//   } catch (error) {
//     setStatus('upload');
//     toast.error('Server connection failed. Please check if Backend is running.', { id: 'analysis' });
//   }
// };
const handleStartAnalysis = async (mGE: File, mDM: File, mCNA: File) => {
  setStatus('loading');
  ...
  try {
    ...
    setStatus('upload');
    toast.error('Server connection failed. Check if Backend is running.', { id: 'analysis' });
  }
};
  return (

...
const steps = [
  ...
  { icon: <Dna className="w-5 h-5" />, text: "Applying Autoencoder Dimensionality Reduction..." },
  { icon: <BrainCircuit className="w-5 h-5" />, text: "Running CTGAN for Data Augmentation..." },
